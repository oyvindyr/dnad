...
contains
    ...
    pure function matmul_dd(u,v) result(res)
        type(dual3), intent(in) :: u(:,:), v(:,:)
        type(dual3) :: res(size(u,1), size(v,2))
    ...
    elemental function max_dd(val1, val2) result(res)
        type(dual3), intent(in) :: val1, val2
        type(dual3) :: res
    ...
    elemental function dmax1_dd(val1, val2, val3, val4,val5) result(res)
        type(dual3), intent(in) :: val1, val2
        type(dual3), intent(in), optional :: val3, val4,val5
        type(dual3) :: res
    ...
    elemental function dmin1_dd(val1, val2, val3, val4) result(res)
        type(dual3), intent(in) :: val1, val2
        type(dual3), intent(in), optional :: val3, val4
        type(dual3) :: res
