...
module dnad1_mod
    ...
    integer, parameter :: number_of_derivatives = 1 ! ndv_literal will be replaced by pre-processor
    ...
    public dual1
    type :: dual1  ! make this private will create difficulty to use the
