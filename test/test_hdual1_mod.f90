...
contains
    ...
    function test_hdual1() result(is_ok)
        ...
        do i = 1, nval
            ...
            xd(i) = initialize_dual(x(i), 1)
            yd(i) = initialize_dual(y(i), 2)
            
            xhd(i) = initialize_hdual(x(i), 1)
            yhd(i) = initialize_hdual(y(i), 2)
    ...
    impure elemental  function eq_hd_hd(lhs, rhs) result(res)
         type(hdual_xy), intent(in) :: lhs, rhs
         logical :: res
